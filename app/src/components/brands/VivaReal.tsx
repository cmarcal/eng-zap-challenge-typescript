  ...
  return (
    <>
      { headerBrand ?
        ...
        : 
        <ImageContainer onClick={onClick}  width={width || 'auto'} data-testid='VivaRealImage' src="https://cdnfiles.vivareal.com/emails/v2/logo-vivareal.png" alt='Viva Real logo'/>
      }
    </>
    )
}
